...
mod tests {
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_5mb_chunk_crc64nvme() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_5mb_chunk_sha256() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_5mb_chunk_crc64nvme() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_single_upload_5mb_minus_1_5mb_chunk_sha256() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_single_upload_5mb_minus_1_5mb_chunk_crc64nvme() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_auto_chunksize_sha256() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_auto_chunksize_crc64nvme() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_kms_sha256() {
        TestHelper::init_dummy_tracing_subscriber();
    ...
    #[tokio::test]
    async fn test_multipart_upload_5mb_plus_1_kms_crc64nvme() {
        TestHelper::init_dummy_tracing_subscriber();
