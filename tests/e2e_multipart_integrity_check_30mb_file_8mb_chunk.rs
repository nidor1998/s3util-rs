...
mod tests {
    ...
    async fn test_multipart_upload_30mb_sha256() {
        ...
        let local_dir = TestHelper::create_temp_dir();
        let test_file = TestHelper::create_sized_file(&local_dir, "30mb_sha256.bin", 30 * 1024 * 1024);
    ...
    async fn test_multipart_upload_30mb_crc64nvme() {
        ...
        let local_dir = TestHelper::create_temp_dir();
        let test_file = TestHelper::create_sized_file(&local_dir, "30mb_crc64.bin", 30 * 1024 * 1024);
