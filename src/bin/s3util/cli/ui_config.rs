...
mod tests {
    ...
    fn cp_args_from(cli: Cli) -> s3util_rs::config::args::CpArgs {
        match cli.command {
            ...
            | Commands::DeleteBucketReplication(_)
            ...
            | Commands::GetBucketAccelerateConfiguration(_)
            ...
            | Commands::GetBucketPolicyStatus(_)
            | Commands::GetBucketReplication(_)
            | Commands::GetBucketRequestPayment(_)
            ...
            | Commands::PutBucketReplication(_)
            | Commands::PutBucketRequestPayment(_)
